...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground shadow-soft hover:shadow-gold hover:brightness-110',
        destructive:
        ...
        ghost: 'hover:bg-glass-hover hover:text-accent',
        link: 'text-primary underline-offset-4 hover:underline',
        gold: 'bg-gradient-to-r from-gold to-gold-light text-charcoal font-semibold shadow-soft hover:shadow-gold-strong hover:brightness-110',
      },
      size: {
